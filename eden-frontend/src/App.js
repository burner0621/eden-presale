...
function App() {
  ...
  return (
    <div className="App bg-white bg-center bg-cover" style={{ backgroundImage: "url('/assets/img/pattern1.png')"}}>
      <ThemeContext.Provider value={tokens}>
        <WalletConnectProvider>
          <Navbar></Navbar>
          <div className='px-5 md:px-10 lg:px-0 pt-6 md:pt-[55px] pb-[160px] flex flex-col'>
            <PresalePart />
            <Claim />
            <Dive />
          </div>
