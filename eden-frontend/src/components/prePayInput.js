    ...
    return (
        <div className="flex flex-col mt-4 text-black">
            <div className="flex flex-row justify-between items-center">
                <div className="text-[16px] leading-[16.94px]">
                    {title}:
                </div>
                <div className="flex flex-row text-[14px] font-medium leading-[15.73px] items-center">
                    <img src='/assets/img/wallet.svg' className='ml-0.5 text-black' />
                    <div> {numberWithCommas(balance.toFixed(2))} {tokens[dropIndex].ft}</div>
                </div>
            </div>
            <div className="h-[41px] flex flex-row pl-3 rounded-2xl bg-white border border-solid border-dark-green relative items-center mt-2">
                ...
                <div className="bg-white min-w-[102px] relative rounded-r-[32px] px-2 py-3 h-[95%] cursor-pointer flex flex-row items-center" onClick={handleDrop}>
