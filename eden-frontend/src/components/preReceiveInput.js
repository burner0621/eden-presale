    ...
    return (
        <div className="flex flex-col mt-6 text-black">
            <div className="flex flex-row justify-between items-center">
                <div className="text-[16px] font-normal leading-[16.94px]">
                    {title}:
                </div>
                <div className="flex flex-row text-[14px] font-medium leading-[15.73px] items-center">
                    ...
                    <div> {numberWithCommas(balance.toFixed(2))} EDN</div>
                </div>
            </div>
            <div className="h-[41px] flex flex-row pl-3 rounded-2xl mt-2 bg-white border border-solid border-dark-green relative items-center">
                <img src='/assets/icon/eden.svg' className="w-4 h-4"/>
